...
import { createProduct, getProducts, patchProductCompanyInventoryQty, } from "../../services/productsService";
...
export default function ProductNewPage() {
    ...
    return (<section>
      ...
      <ProductForm submitting={submitting} existingAreas={existingAreas} existingTipos={existingTipos} onSubmit={async (data) => {
            setSubmitting(true);
            setError(null);
            try {
                ...
                if (quantity > 0 && defaultWarehouseId) {
                    ...
                    setError("Hay cantidad indicada pero no hay almacén: el producto se creó sin stock. Crea un almacén y asigna stock después.");
                }
