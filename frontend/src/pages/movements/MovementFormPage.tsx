...
export default function MovementFormPage() {
    ...
    return (<section>
      <PageHeader title="Nuevo movimiento" description="Salida: material del almacén al evento. Entrada: devolución del evento al almacén."/>
      {error && <ErrorMessage message={error}/>}
      {okId && (<p className="success" role="status">
