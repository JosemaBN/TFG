...
export const PlantillaMovementButton = memo(function PlantillaMovementButton(p: BtnProps) {
    ...
    const title = p.movementType === "SALIDA"
        ? !ok
            ? "Indica una Ud ≥ 1"
    ...
    return (<button type="button" className="planilla-ctl-btn" disabled={busy || (p.movementType === "ENTRADA" ? inDisabled : outDisabled)} title={title} onClick={async () => {
